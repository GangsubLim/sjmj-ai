...
공유한다. 두 파일에 복제하면(과거에 그랬다) 스플리터 계약
(test_migration_010_item_vocabulary.test_statement_splitter_matches_mysql_comment_rule)이
한쪽만 갱신되는 사이 실제 러너(`mysql < file`)와 갈리는 false-green이 생긴다.
