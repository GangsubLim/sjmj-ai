...
from ocr_poc.data import LabelRow, Sample
...
def test_run_pipeline_end_to_end_with_fakes(tmp_path):
    ...
    cells = [
        DetectedCell(0, 1, (10, 0, 20, 10)),
        DetectedCell(0, 2, (20, 0, 30, 10)),
        DetectedCell(0, 3, (30, 0, 40, 10)),
        DetectedCell(1, 1, (10, 20, 20, 30)),
        DetectedCell(1, 2, (20, 20, 30, 30)),
    ...
    gt = {
        "inv_x": GroundTruth(
            "inv_x", 1, (InvoiceItem(1, 1, "부동액", 4, 25000, 100000, 10000, 110000),)
        )
    }
